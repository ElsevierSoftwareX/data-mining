...
my $create_dictionary_freq = undef;
my $create_dictionary_freq_classes = undef;
...
my $sentences = undef;
my $output_original_texts = undef;
my $output_tokens = undef;
...
my $error = GetOptions(
	...
	'create_dictionary_freq' => \$create_dictionary_freq,
	'create_dictionary_freq_classes' => \$create_dictionary_freq_classes,		
	...
	'output_original_texts' => \$output_original_texts,
...
$create_dictionary = 'plain' if $create_dictionary;
$create_dictionary = 'with frequencies' if $create_dictionary_freq;
$create_dictionary = 'with frequencies for classes' if $create_dictionary_freq_classes;
